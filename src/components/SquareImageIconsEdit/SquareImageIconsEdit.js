...
const SquareImageIconsEdit = ({ images }) => {
    ...
    <View style={styles.container}>
      {images.map((image, index) => (
        <TouchableOpacity
          ...
          key={index}
        >
          <Image source={{ uri: `https://backend.carologyauctions.net/images/${image}` }} style={styles.icon} />
        </TouchableOpacity>
      ))}
...
export default SquareImageIconsEdit;